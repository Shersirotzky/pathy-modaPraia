...
export default function Home() {
  return <>
    ...
    <section className="home-section page-shell featured-section"><div className="section-heading"><div><p className="eyebrow">Os mais desejados</p><h2>Escolhas da Pathy</h2></div></div><FeaturedCarousel products={products.filter((p) => p.featured)} /></section>
